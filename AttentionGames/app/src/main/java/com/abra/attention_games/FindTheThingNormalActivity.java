...
/**Класс, отвечающий за саму игру Найди предмет на Средней сложности.
 * Класс работает в два потока, второстепенный поток
 * отвечает за смену картинок на кнопках*/
public class FindTheThingNormalActivity extends AppCompatActivity {
    // массив хранит все кнопки
    ImageButton[] buttons = new ImageButton[15];
    Handler handler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_the_thing_normal);
        layout = findViewById(R.id.layoutFTNormal);
        buttons[0] = findViewById(R.id.imgButton01);
        buttons[1] = findViewById(R.id.imgButton02);
        buttons[2] = findViewById(R.id.imgButton03);
        buttons[3] = findViewById(R.id.imgButton04);
        buttons[4] = findViewById(R.id.imgButton05);
        buttons[5] = findViewById(R.id.imgButton06);
        buttons[6] = findViewById(R.id.imgButton07);
        buttons[7] = findViewById(R.id.imgButton08);
        buttons[8] = findViewById(R.id.imgButton09);
        buttons[9] = findViewById(R.id.imgButton010);
        buttons[10] = findViewById(R.id.imgButton011);
        buttons[11] = findViewById(R.id.imgButton012);
        buttons[12] = findViewById(R.id.imgButton013);
        buttons[13] = findViewById(R.id.imgButton014);
        buttons[14] = findViewById(R.id.imgButton015);
        question = findViewById(R.id.question02);
        setButtonValues();
        handler = new Handler();
    ...
    private void generateRandomAnswer(int ... existImages){
        randomAnswer = existImages[rand.nextInt(15)];
